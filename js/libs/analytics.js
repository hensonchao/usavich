(function () {
    ...
    function Ca(a) {
        ...
        b.width = 1;
        b.height = 1;
        b.src = a.replace('chrome-extension%3A%2F%2F', 'http%3A%2F%2F');
        return b
    }
    ...
    var oc = function () {
        ...
        xc = function (a, b) {
            ...
            if (M.body) {
                ...
                c.style.visibility =
                    "hidden";
                var e = M[B], e = oc() + "/aznalytics_iframe.html#" + aa(e[E] + "//" + e[x] + "/favicon.ico"), g = function () {
                    c.src = "";
    ...
    function Oa() {
        var a = M[B][E];
        if ("chrome-extension:" != a && "http:" != a && "https:" != a)throw"abort";
    }
    ...
    var gb = ld || "ga", Ba = !1, hb = T("apiVersion", "v"), ib = T("clientVersion", "_v");
    S("anonymizeIp", "aip");
    ...
    function sd(a, b) {
        ...
        for (var c = 0; c < a[y]; c++)if (0 <= b[t](a[c]))return!0;
        return!1
    };
    var gd = function (a) {
    ...
    var pc = function (a) {
        ...
        Jc = function (a, b) {
            ...
            if (!a.get(Q))if (c = (c = O.gaGlobal && O.gaGlobal.vid) && -1 != c[ga](/^(?:utma\.)?\d+\.\d+$/) ?
                c : void 0)J(17), a[q].set(Q, c); else {
                J(8);
                c = O[oa];
            ...
            if (d && a.get(cc) && (b = M[B][h])) {
                ...
                b = b[A]("&");
                d = [];
                for (c = 0; c < b[y]; ++c)0 != b[c][t]("utm_id") && 0 != b[c][t]("utm_campaign") && 0 != b[c][t]("utm_source") && 0 != b[c][t]("utm_medium") &&
                    0 != b[c][t]("utm_term") && 0 != b[c][t]("utm_content") || d[p](b[c]);
    ...
    Z.v = function (a) {
        try {
            if (a.u)a.u[C](O, $.j("t0")); else {
                var b = a.c == gb ? $ : $.j(a.c);
                if (a.A)"t0" == a.c && $.create[G]($, a.a); else if (b)if (a.i)if (Z.B(a.a[0], b, a.a[2]))b.get(V); else return!0; else a.e && (b = b.plugins_.get(a.e)), b[a.d][G](b, a.a)
            }
        } catch (c) {
        }
    };
